...
EasyBuy is a mobile application that allow users to connect with different vendors and hawkers . Multiple vendors can register their products for a negotiable price, customers can filter vendors according to their locailty and compare mulitple prices for similar products and contact the vendor with the best selling price.
